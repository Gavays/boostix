    ...
    <div className="landing">
      ...
      <section className="hero">
        <div className="container">
          ...
          <button className="btn-hero" onClick={() => navigate('/login')}>🚀 Запустить рост</button>
        ...
        <div className="container">
          <div className="smart-feature-content">
            <div className="smart-feature-text">
              ...
              <p>Вставьте ссылку на профиль или пост. Наш ИИ определит платформу, проанализирует аккаунт и предложит лучшие услуги для максимального роста.</p>
        ...
        <div className="container">
          <div className="auto-boost-content">
            <div className="auto-boost-text">
              ...
              <p>Укажите желаемые метрики и дневной бюджет. Boostix автоматически распределит средства между разными услугами, чтобы достичь цели максимально эффективно.</p>
              <div className="auto-steps">
                <div className="auto-step">
                  <div className="step-icon">1</div>
                  <div><strong>Ставите цель</strong><p>Например: +5000 подписчиков за месяц</p></div>
                </div>
                <div className="auto-step">
                  <div className="step-icon">2</div>
                  <div><strong>Указываете бюджет</strong><p>Дневной лимит, который нельзя превышать</p></div>
                </div>
                <div className="auto-step">
                  <div className="step-icon">3</div>
                  <div><strong>Наблюдаете за ростом</strong><p>Система сама закупает нужные услуги</p></div>
                </div>
              </div>
            </div>
            <div className="auto-boost-visual">
              <div className="budget-panel">
                ...
                <div className="budget-row"><span>Цель</span><span>+5000 подписчиков</span></div>
                <div className="budget-row"><span>Бюджет/день</span><span>до 2 500 ₽</span></div>
                <div className="budget-row"><span>Прогноз</span><span className="highlight">22 дня</span></div>
        ...
        <div className="container">
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <p>Используем только безопасные методы продвижения. Если аккаунт пострадает — вернём деньги.</p>
            </div>
            <div className="feature-card">
              <span className="feature-icon">📊</span>
              <h3>Живая аналитика</h3>
              <p>Графики роста, прогнозы выполнения и отчёты в реальном времени.</p>
            </div>
            <div className="feature-card">
              <span className="feature-icon">👥</span>
              <h3>Реферальная система</h3>
              <p>Приглашайте друзей и получайте до 15% от их пополнений. Три уровня.</p>
            </div>
            <div className="feature-card">
              <span className="feature-icon">⚡</span>
              <h3>Мгновенный запуск</h3>
              <p>Заказы стартуют сразу после оплаты. Без задержек, без ручной обработки.</p>
            </div>
            <div className="feature-card">
              <span className="feature-icon">💎</span>
            ...
            <div className="feature-card">
              <span className="feature-icon">🔒</span>
              <h3>Безопасность</h3>
              <p>Ваши данные надёжно защищены. Никакие пароли не передаются третьим лицам.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="cta">
        <div className="container">
          ...
          <button className="btn-hero" onClick={() => navigate('/login')}>🤖 Запустить Boostix</button>
        </div>
      </section>
